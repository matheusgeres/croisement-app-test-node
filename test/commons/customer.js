...
exports.applyVoucher = async function (env, requestData) {
  let path = "/app/cart/apply-voucher";
  let form = {
    voucherCode: requestData.voucher,
    cartCode: env.cartCode,
  };
  return new Promise((resolve, reject) => {
    request.post(
      {
      ...
      function (error, response, body) {
        ...
        logger.error("RESPONSE OF VOUCHER", _body);

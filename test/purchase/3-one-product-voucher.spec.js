...
describe("Make a purchase with one product", function () {
  ...
  xstep("Retrieve All Addresses", async function (done) {
  ...
  xstep("Set Delivery Address", async function (done) {
    const requestData = {
      url      : url,
      headers  : headers,
      cartCode : cartCode,
  ...
  xstep("Add Product to Cart", async function (done) {
    const requestData = {
      url         : url,
      headers     : headers,
  ...
  step("Apply voucher", async function (done) {
